...
anno_scoperta: 1944
anno_stimato: false
scopritori: [Glenn Seaborg, Ralph Arthur James, Albert Ghiorso]
epoca: Era nucleare
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 95
tempo_lettura: 4
...
flowchart LR
    E["Curio"]
    C1["Ossido di curio<br/>Cm2O3"]
    E --> C1
    U1(["sorgenti per spettrometri alfa a raggi X"])
    C1 --> U1
    U2(["bersagli per la sintesi"])
    C1 --> U2
    C2["Curio-244<br/>244Cm"]
    E --> C2
    U3(["sorgenti termiche"])
    C2 --> U3
    U4(["analisi elementare su sonde spaziali"])
    C2 --> U4
