...
flowchart LR
    E["Rame"]
    C1["Solfato di rame<br/>CuSO4"]
    E --> C1
    U1(["fungicidi agricoli"])
    C1 --> U1
    U2(["elettrodeposizione"])
    C1 --> U2
    U3(["reagente da laboratorio"])
    C1 --> U3
    C2["Ossido di rame<br/>Cu2O"]
    E --> C2
    U4(["pigmenti"])
    C2 --> U4
    U5(["celle solari sperimentali"])
    C2 --> U5
    U6(["antivegetativi navali"])
    C2 --> U6
