...
flowchart LR
    E["Flerovio"]
    C1["Flerovio-289<br/>289Fl"]
    E --> C1
    U1(["esperimenti di adsorbimento su superficie d'oro"])
    C1 --> U1
    U2(["studio della stabilità di guscio"])
    C1 --> U2
    C2["Diossido di flerovio<br/>FlO₂"]
    E --> C2
    U3(["composto previsto e ritenuto instabile, mai preparato"])
    C2 --> U3
