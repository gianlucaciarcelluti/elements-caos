...
anno_scoperta: 1961
anno_stimato: false
scopritori: [Albert Ghiorso, Torbjørn Sikkeland, Almon E. Larsh, Robert M. Latimer]
epoca: Era nucleare
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 103
tempo_lettura: 5
ha_approfondimento: false
tags: [elemento, attinide, epoca/nucleare, secolo/XX]
aliases: [Lr, Lawrencium]
---
...
flowchart TB
    S["Lantanio<br/>La"]
    S -->|stesso gruppo| C
    C["Laurenzio<br/>Lr · Z=103"]
    L["Nobelio<br/>No"]
    L -->|stesso periodo| C
    R["Rutherfordio<br/>Rf"]
    C -->|stesso periodo| R
...
flowchart LR
    E["Laurenzio"]
    C1["Ione laurenzio(III)<br/>Lr³⁺"]
    E --> C1
    U1(["esperimenti di eluizione a scambio ionico"])
    C1 --> U1
    U2(["misura del raggio ionico"])
    C1 --> U2
    C2["Fluoruro di laurenzio<br/>LrF₃"]
    E --> C2
    U3(["studi di coprecipitazione con i fluoruri degli attinidi trivalenti"])
    C2 --> U3
    C3["Laurenzio-260<br/>260Lr"]
    E --> C3
    U4(["esperimenti di chimica su pochi atomi"])
    C3 --> U4
