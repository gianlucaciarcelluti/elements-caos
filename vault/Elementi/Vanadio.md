...
flowchart LR
    E["Vanadio"]
    C1["Pentossido di vanadio<br/>V2O5"]
    E --> C1
    U1(["catalizzatore per l'acido solforico"])
    C1 --> U1
    U2(["pigmento per ceramiche e vetri"])
    C1 --> U2
    C2["Solfato di vanadile<br/>VOSO4"]
    E --> C2
    U3(["elettrolita delle batterie a flusso redox"])
    C2 --> U3
    U4(["reagente di laboratorio"])
    C2 --> U4
    C3["Carburo di vanadio<br/>VC"]
    E --> C3
    U5(["affinamento del grano negli acciai"])
    C3 --> U5
    U6(["utensili da taglio"])
    C3 --> U6
