...
flowchart LR
    E["Tallio"]
    C1["Solfato di tallio(I)<br/>Tl2SO4"]
    E --> C1
    U1(["topicidi e insetticidi, oggi vietati"])
    C1 --> U1
    C2["Bromoioduro di tallio<br/>TlBr-TlI"]
    E --> C2
    U2(["ottiche per l'infrarosso lontano"])
    C2 --> U2
    C3["Ioduro di sodio drogato al tallio<br/>NaI:Tl"]
    E --> C3
    U3(["rivelatori a scintillazione"])
    C3 --> U3
    U4(["medicina nucleare"])
    C3 --> U4
