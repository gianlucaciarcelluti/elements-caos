...
anno_scoperta: 1925
anno_stimato: false
scopritori: [Ida Noddack, Walter Noddack, Otto Berg]
epoca: Spettroscopia e radioattività
categoria: metallo_di_transizione
gruppo: 7
periodo: 6
posizione_cronologica: 88
tempo_lettura: 4
...
flowchart LR
    E["Renio"]
    C1["Perrenato di ammonio<br/>NH4ReO4"]
    E --> C1
    U1(["forma commerciale del renio"])
    C1 --> U1
    U2(["precursore dei catalizzatori"])
    C1 --> U2
    C2["Superlega nichel-renio<br/>Ni-Re"]
    E --> C2
    U3(["palette di turbina"])
    C2 --> U3
    U4(["camere di combustione"])
    C2 --> U4
    C3["Catalizzatore platino-renio<br/>Pt-Re"]
    E --> C3
    U5(["reforming catalitico delle benzine"])
    C3 --> U5
