...
flowchart LR
    E["Bario"]
    C1["Solfato di bario (baritina)<br/>BaSO4"]
    E --> C1
    U1(["mezzo di contrasto radiologico"])
    C1 --> U1
    U2(["appesantente dei fanghi di perforazione"])
    C1 --> U2
    C2["Carbonato di bario<br/>BaCO3"]
    E --> C2
    U3(["vetri ottici e ceramiche"])
    C2 --> U3
    U4(["rodenticida"])
    C2 --> U4
    C3["Nitrato di bario<br/>Ba(NO3)2"]
    E --> C3
    U5(["fuochi d'artificio verdi"])
    C3 --> U5
    U6(["segnalatori luminosi"])
    C3 --> U6
    C4["Ossido di ittrio, bario e rame<br/>YBa2Cu3O7"]
    E --> C4
    U7(["superconduttore ad alta temperatura"])
    C4 --> U7
