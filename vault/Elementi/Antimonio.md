...
gruppo: 15
periodo: 5
posizione_cronologica: 8
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, semimetallo, epoca/antichita, secolo/XXXaC]
aliases: [Sb, Antimony]
---
...
flowchart LR
    ...
    U3(["pigmenti"])
    C1 --> U3
    C2["Triossido di antimonio<br/>Sb2O3"]
    E --> C2
    U4(["ritardante di fiamma sinergico"])
    C2 --> U4
    U5(["opacizzante per smalti e vetro"])
    C2 --> U5
    U6(["catalizzatore per il PET"])
    C2 --> U6
    C3["Antimoniuro di indio<br/>InSb"]
    E --> C3
    U7(["rivelatori a infrarossi"])
    C3 --> U7
    U8(["sensori termici ad alta sensibilità"])
    C3 --> U8
