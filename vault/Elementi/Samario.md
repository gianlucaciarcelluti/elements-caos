...
flowchart LR
    E["Samario"]
    C1["Lega samario-cobalto<br/>SmCo5"]
    E --> C1
    U1(["magneti permanenti per alte temperature"])
    C1 --> U1
    U2(["motori aeronautici"])
    C1 --> U2
    C2["Ioduro di samario(II)<br/>SmI2"]
    E --> C2
    U3(["riducente in sintesi organica"])
    C2 --> U3
    C3["Ossido di samario<br/>Sm2O3"]
    E --> C3
    U4(["assorbitori di neutroni"])
    C3 --> U4
    U5(["vetri ottici"])
    C3 --> U5
    U6(["catalizzatori"])
