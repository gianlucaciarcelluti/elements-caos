...
tags: [elemento, semimetallo, epoca/alchimia, secolo/XVIII]
aliases: [Si, Silicon]
---
...
flowchart LR
    E["Silicio"]
    C1["Biossido di silicio (silice)<br/>SiO2"]
    E --> C1
    U1(["vetro"])
    C1 --> U1
    U2(["sabbia e quarzo"])
    ...
    U3(["fibre ottiche"])
    C1 --> U3
    C2["Carburo di silicio<br/>SiC"]
    E --> C2
    U4(["abrasivi"])
    C2 --> U4
    U5(["materiali refrattari"])
    C2 --> U5
    U6(["elettronica di potenza"])
    C2 --> U6
    C3["Siliconi<br/>(R2SiO)n"]
    E --> C3
    U7(["guarnizioni e sigillanti"])
    C3 --> U7
    U8(["lubrificanti"])
    C3 --> U8
    U9(["protesi mediche"])
    C3 --> U9
    C4["Silicati di alluminio (argille)<br/>Al2Si2O5(OH)4"]
    E --> C4
    U10(["ceramiche e porcellana"])
    C4 --> U10
    U11(["laterizi"])
    C4 --> U11
