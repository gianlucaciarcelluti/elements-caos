...
flowchart LR
    E["Erbio"]
    C1["Ossido di erbio<br/>Er2O3"]
    E --> C1
    U1(["colorante rosa per vetri e ceramiche"])
    C1 --> U1
    U2(["drogaggio delle fibre ottiche"])
    C1 --> U2
    C2["Cristallo Er:YAG<br/>Er:Y3Al5O12"]
    E --> C2
    U3(["laser dermatologici"])
    C2 --> U3
    U4(["laser odontoiatrici"])
    C2 --> U4
    C3["Fibra di silice drogata all'erbio<br/>SiO2:Er"]
    E --> C3
    U5(["amplificatori ottici"])
    C3 --> U5
    U6(["cavi sottomarini"])
    C3 --> U6
