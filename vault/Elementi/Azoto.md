...
flowchart LR
    ...
    C1["Ammoniaca<br/>NH3"]
    E --> C1
    U1(["fertilizzanti azotati"])
    C1 --> U1
    U2(["fluido refrigerante"])
    C1 --> U2
    C2["Acido nitrico<br/>HNO3"]
    E --> C2
    U3(["esplosivi"])
    C2 --> U3
    U4(["concimi e coloranti"])
    C2 --> U4
    C3["Protossido di azoto<br/>N2O"]
    E --> C3
    U5(["anestetico e analgesico"])
    C3 --> U5
    U6(["propellente alimentare"])
    C3 --> U6
    C4["Nitrato di ammonio<br/>NH4NO3"]
    E --> C4
    U7(["concime agricolo"])
    C4 --> U7
    U8(["esplosivi da cava"])
    C4 --> U8
