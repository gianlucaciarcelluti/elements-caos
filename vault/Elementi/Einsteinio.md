...
anno_scoperta: 1952
anno_stimato: false
scopritori: [Albert Ghiorso, Stanley Gerald Thompson, Glenn Seaborg]
epoca: Era nucleare
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 99
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, attinide, epoca/nucleare, secolo/XX]
aliases: [Es, Einsteinium]
---
...
```mermaid
timeline
    title Scoperta dell'Einsteinio
...
flowchart LR
    E["Einsteinio"]
    C1["Einsteinio-253<br/>253Es"]
    E --> C1
    U1(["bersaglio per la sintesi del mendelevio"])
    C1 --> U1
    U2(["ricerca sugli attinidi"])
    C1 --> U2
    C2["Ossido di einsteinio<br/>Es2O3"]
    E --> C2
    U3(["studi di chimica e struttura degli attinidi pesanti"])
    C2 --> U3
