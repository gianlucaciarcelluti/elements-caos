...
anno_scoperta: 1894
anno_stimato: false
scopritori: [William Ramsay, Lord Rayleigh]
epoca: Spettroscopia e radioattività
categoria: gas_nobile
gruppo: 18
periodo: 3
posizione_cronologica: 76
tempo_lettura: 4
...
flowchart LR
    E["Argon"]
    C1["Argon gassoso<br/>Ar"]
    E --> C1
    U1(["atmosfera protettiva per saldatura"])
    C1 --> U1
    U2(["riempimento di lampade e doppi vetri"])
    C1 --> U2
    C2["Fluoroidruro di argon<br/>HArF"]
    E --> C2
    U3(["unico composto noto dell'argon, stabile solo a bassissima temperatura"])
    C2 --> U3
