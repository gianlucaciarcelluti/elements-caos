...
anno_scoperta: 1898
anno_stimato: false
scopritori: [William Ramsay, Morris Travers]
epoca: Spettroscopia e radioattività
categoria: gas_nobile
gruppo: 18
periodo: 4
posizione_cronologica: 78
tempo_lettura: 4
...
flowchart LR
    E["Cripton"]
    C1["Difluoruro di cripton<br/>KrF2"]
    E --> C1
    U1(["ossidante fortissimo"])
    C1 --> U1
    U2(["chimica dei gas nobili"])
    C1 --> U2
    C2["Cripton gassoso<br/>Kr"]
    E --> C2
    U3(["lampade a incandescenza e fluorescenti"])
    C2 --> U3
    U4(["flash fotografici"])
    C2 --> U4
    U5(["laser"])
    C2 --> U5
