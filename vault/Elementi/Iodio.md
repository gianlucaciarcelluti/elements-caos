...
flowchart LR
    E["Iodio"]
    C1["Ioduro di potassio<br/>KI"]
    E --> C1
    U1(["iodazione del sale da cucina"])
    C1 --> U1
    U2(["profilassi tiroidea in caso di incidente nucleare"])
    C1 --> U2
    U3(["fotografia"])
    C1 --> U3
    C2["Ioduro d'argento<br/>AgI"]
    E --> C2
    U4(["emulsioni fotografiche"])
    C2 --> U4
    U5(["inseminazione delle nubi"])
    C2 --> U5
    C3["Ioduro di sodio<br/>NaI"]
    E --> C3
    U6(["rivelatori a scintillazione per raggi gamma"])
    C3 --> U6
    U7(["integrazione alimentare"])
    C3 --> U7
