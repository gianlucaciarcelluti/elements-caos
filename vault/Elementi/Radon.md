...
anno_scoperta: 1900
anno_stimato: false
scopritori: [Friedrich Ernst Dorn]
epoca: Spettroscopia e radioattività
categoria: gas_nobile
gruppo: 18
periodo: 6
posizione_cronologica: 83
tempo_lettura: 4
...
flowchart LR
    E["Radon"]
    C1["Radon gassoso<br/>Rn"]
    E --> C1
    U1(["tracciante geologico"])
    C1 --> U1
    U2(["radioterapia storica"])
    C1 --> U2
    C2["Difluoruro di radon<br/>RnF2"]
    E --> C2
    U3(["chimica dei gas nobili, studiata solo in tracce"])
    C2 --> U3
