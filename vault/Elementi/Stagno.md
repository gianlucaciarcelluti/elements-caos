...
gruppo: 14
periodo: 5
posizione_cronologica: 7
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, metallo-post-transizione, epoca/antichita, millennio/4aC]
aliases: [Sn, Tin]
---
...
flowchart LR
    E["Stagno"]
    C1["Cassiterite<br/>SnO2"]
    E --> C1
    U1(["minerale principale dello stagno"])
    C1 --> U1
    U2(["opacizzante per smalti ceramici"])
    C1 --> U2
    C2["Cloruro stannoso<br/>SnCl2"]
    E --> C2
    U3(["riducente in chimica analitica"])
    C2 --> U3
    U4(["mordente per tintura"])
    C2 --> U4
    U5(["stagnatura chimica"])
    C2 --> U5
    C3["Ossido di stagno e indio<br/>In2O3·SnO2"]
    E --> C3
    U6(["elettrodi trasparenti per schermi e touchscreen"])
    C3 --> U6
    U7(["celle fotovoltaiche"])
    C3 --> U7
