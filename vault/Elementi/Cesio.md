...
anno_scoperta: 1860
anno_stimato: false
scopritori: [Gustav Kirchhoff, Robert Bunsen]
epoca: Spettroscopia e radioattività
categoria: metallo_alcalino
gruppo: 1
periodo: 6
posizione_cronologica: 61
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, metallo-alcalino, epoca/spettroscopia, secolo/XIX]
aliases: [Cs, Cesium]
---
...
flowchart LR
    E["Cesio"]
    C1["Cloruro di cesio<br/>CsCl"]
    E --> C1
    U1(["centrifugazione in gradiente di densità"])
    C1 --> U1
    U2(["reagente di laboratorio"])
    C1 --> U2
    C2["Formiato di cesio<br/>HCOOCs"]
    E --> C2
    U3(["fluidi da perforazione ad alta densità"])
    C2 --> U3
    C3["Idrossido di cesio<br/>CsOH"]
    E --> C3
    U4(["base fortissima"])
    C3 --> U4
    U5(["elettroliti per celle a combustibile"])
    C3 --> U5
