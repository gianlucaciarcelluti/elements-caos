...
anno_scoperta: 1879
anno_stimato: false
scopritori: [Per Teodor Cleve]
epoca: Spettroscopia e radioattività
categoria: lantanide
gruppo: 3
periodo: 6
posizione_cronologica: 71
tempo_lettura: 4
...
flowchart LR
    E["Tulio"]
    C1["Ossido di tulio<br/>Tm2O3"]
    E --> C1
    U1(["drogaggio di cristalli laser"])
    C1 --> U1
    U2(["inchiostri di sicurezza"])
    C1 --> U2
    C2["Cristallo Tm:YAG<br/>Tm:Y3Al5O12"]
    E --> C2
    U3(["laser chirurgici"])
    C2 --> U3
    U4(["telemetri sicuri per la vista"])
    C2 --> U4
