...
anno_scoperta: 1880
anno_stimato: false
scopritori: [Jean Charles Galissard de Marignac]
epoca: Spettroscopia e radioattività
categoria: lantanide
gruppo: 3
periodo: 6
posizione_cronologica: 72
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, lantanide, epoca/spettroscopia, secolo/XIX]
aliases: [Gd, Gadolinium]
---
...
flowchart LR
    E["Gadolinio"]
    C1["Ossisolfuro di gadolinio<br/>Gd2O2S"]
    E --> C1
    U1(["schermi per radiografia digitale"])
    C1 --> U1
    U2(["rivelatori a scintillazione"])
    C1 --> U2
    C2["Complessi di gadolinio<br/>Gd-DTPA"]
    E --> C2
    U3(["mezzi di contrasto per risonanza magnetica"])
    C2 --> U3
    C3["Granato di gadolinio e gallio<br/>Gd3Ga5O12"]
    E --> C3
    U4(["substrati per film magnetici"])
    C3 --> U4
    U5(["ottica"])
    C3 --> U5
