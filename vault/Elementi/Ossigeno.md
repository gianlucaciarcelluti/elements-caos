...
tags: [elemento, non-metallo, epoca/pneumatica, secolo/XVIII]
aliases: [O, Oxygen]
---
...
flowchart LR
    ...
    C1["Acqua<br/>H2O"]
    E --> C1
    U1(["solvente della biochimica"])
    C1 --> U1
    U2(["regolazione del clima terrestre"])
    C1 --> U2
    C2["Biossido di silicio (silice)<br/>SiO2"]
    E --> C2
    U3(["roccia e sabbia della crosta terrestre"])
    C2 --> U3
    U4(["vetro"])
    C2 --> U4
    C3["Ozono<br/>O3"]
    E --> C3
    U5(["schermo dai raggi ultravioletti"])
    C3 --> U5
    U6(["disinfezione delle acque"])
    C3 --> U6
    C4["Perossido di idrogeno (acqua ossigenata)<br/>H2O2"]
    E --> C4
    U7(["disinfettante"])
    C4 --> U7
    U8(["sbiancante"])
