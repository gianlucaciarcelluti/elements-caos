...
anno_scoperta: 1817
anno_stimato: false
scopritori: [Karl Samuel Leberecht Hermann, Friedrich Stromeyer, Johann Christoff Heinrich Roloff]
epoca: L'età dell'elettrolisi
categoria: metallo_di_transizione
gruppo: 12
periodo: 5
posizione_cronologica: 53
tempo_lettura: 4
...
flowchart LR
    E["Cadmio"]
    C1["Solfuro di cadmio<br/>CdS"]
    E --> C1
    U1(["pigmento giallo di cadmio"])
    C1 --> U1
    U2(["fotoresistenze"])
    C1 --> U2
    U3(["strati di celle solari"])
    C1 --> U3
    C2["Tellururo di cadmio<br/>CdTe"]
    E --> C2
    U4(["pannelli fotovoltaici a film sottile"])
    C2 --> U4
    C3["Ossido di cadmio<br/>CdO"]
    E --> C3
    U5(["elettrodi delle batterie al nichel-cadmio"])
    C3 --> U5
    U6(["rivestimenti"])
    C3 --> U6
    U7(["catalizzatori"])
    C3 --> U7
    C4["Seleniuro di cadmio<br/>CdSe"]
    E --> C4
    U8(["punti quantici per schermi e imaging"])
    C4 --> U8
    U9(["pigmenti rossi"])
    C4 --> U9
    U10(["optoelettronica"])
