...
anno_scoperta: 1829
anno_stimato: false
scopritori: [Jöns Jacob Berzelius]
epoca: L'età dell'elettrolisi
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 55
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, attinide, epoca/elettrolisi, secolo/XIX]
aliases: [Th, Thorium]
---
...
flowchart LR
    E["Torio"]
    C1["Biossido di torio<br/>ThO2"]
    E --> C1
    U1(["reticelle per lampade a gas"])
    C1 --> U1
    U2(["crogioli refrattari"])
    C1 --> U2
    U3(["catalizzatori"])
    C1 --> U3
    C2["Nitrato di torio<br/>Th(NO3)4"]
    E --> C2
    U4(["preparazione delle reticelle"])
    C2 --> U4
    U5(["reagente di laboratorio"])
    C2 --> U5
    C3["Lega tungsteno-torio<br/>W-ThO2"]
    E --> C3
    U6(["elettrodi per saldatura ad arco"])
    C3 --> U6
    U7(["filamenti termoionici"])
    C3 --> U7
