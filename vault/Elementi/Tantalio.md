...
flowchart LR
    E["Tantalio"]
    C1["Pentossido di tantalio<br/>Ta2O5"]
    E --> C1
    U1(["dielettrico dei condensatori"])
    C1 --> U1
    U2(["vetri ottici ad alto indice di rifrazione"])
    C1 --> U2
    C2["Carburo di tantalio<br/>TaC"]
    E --> C2
    U3(["utensili da taglio"])
    C2 --> U3
    U4(["materiali ultrarefrattari"])
    C2 --> U4
    C3["Tantalato di litio<br/>LiTaO3"]
    E --> C3
    U5(["componenti piezoelettrici"])
    C3 --> U5
    U6(["filtri per la telefonia mobile"])
    C3 --> U6
