...
anno_scoperta: 1825
anno_stimato: false
scopritori: [Antoine Jérôme Balard, Carl Löwig]
epoca: L'età dell'elettrolisi
categoria: alogeno
gruppo: 17
periodo: 4
posizione_cronologica: 54
tempo_lettura: 5
ha_approfondimento: false
tags: [elemento, alogeno, epoca/elettrolisi, secolo/XIX]
aliases: [Br, Bromine]
---
...
flowchart LR
    E["Bromo"]
    C1["Bromuro di calcio<br/>CaBr2"]
    E --> C1
    U1(["fluidi densi per il completamento dei pozzi"])
    C1 --> U1
    U2(["sali antighiaccio"])
    C1 --> U2
    C2["Bromuro d'argento<br/>AgBr"]
    E --> C2
    U3(["emulsioni fotografiche"])
    C2 --> U3
    U4(["lenti fotocromatiche"])
    C2 --> U4
    C3["Bromuro di sodio<br/>NaBr"]
    E --> C3
    U5(["fluidi di perforazione"])
    C3 --> U5
    U6(["disinfezione delle acque"])
    C3 --> U6
    U7(["sedativi (uso storico)"])
    C3 --> U7
    C4["Bromuro di metile<br/>CH3Br"]
    E --> C4
    U8(["fumigante agricolo, in dismissione per il protocollo di Montreal"])
    C4 --> U8
