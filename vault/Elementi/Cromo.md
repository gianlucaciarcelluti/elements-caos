...
flowchart LR
    E["Cromo"]
    C1["Cromite<br/>FeCr2O4"]
    E --> C1
    U1(["unico minerale di cromo sfruttato industrialmente"])
    C1 --> U1
    C2["Ossido di cromo(III)<br/>Cr2O3"]
    E --> C2
    U2(["verde cromo per pitture e ceramiche"])
    C2 --> U2
    U3(["abrasivo per lucidatura"])
    C2 --> U3
    C3["Cromato di piombo<br/>PbCrO4"]
    E --> C3
    U4(["giallo cromo, pigmento storico"])
    C3 --> U4
    C4["Triossido di cromo<br/>CrO3"]
    E --> C4
    U5(["bagni per la cromatura galvanica"])
    C4 --> U5
