...
flowchart LR
    E["Molibdeno"]
    C1["Disolfuro di molibdeno (molibdenite)<br/>MoS2"]
    E --> C1
    U1(["lubrificante solido ad alta temperatura"])
    C1 --> U1
    U2(["catalizzatore di desolforazione"])
    C1 --> U2
    C2["Triossido di molibdeno<br/>MoO3"]
    E --> C2
    U3(["intermedio per la produzione del metallo"])
    C2 --> U3
    U4(["additivo per pigmenti"])
    C2 --> U4
    C3["Molibdato di ammonio<br/>(NH4)6Mo7O24"]
    E --> C3
    U5(["reattivo per la determinazione dei fosfati"])
    C3 --> U5
    U6(["microfertilizzante"])
    C3 --> U6
    C4["Cofattore ferro-molibdeno della nitrogenasi<br/>MoFe7S9C"]
    E --> C4
    U7(["fissazione biologica dell'azoto"])
    C4 --> U7
