...
flowchart LR
    E["Tellurio"]
    C1["Tellururo di cadmio<br/>CdTe"]
    E --> C1
    U1(["celle fotovoltaiche a film sottile"])
    C1 --> U1
    U2(["rivelatori di raggi X e gamma"])
    C1 --> U2
    C2["Tellururo di bismuto<br/>Bi2Te3"]
    E --> C2
    U3(["moduli termoelettrici"])
    C2 --> U3
    U4(["refrigerazione a effetto Peltier"])
    C2 --> U4
    C3["Calaverite (tellururo d'oro)<br/>AuTe2"]
    E --> C3
    U5(["minerale d'oro nei giacimenti telluriferi"])
    C3 --> U5
    C4["Biossido di tellurio<br/>TeO2"]
    E --> C4
    U6(["vetri ottici a elevato indice di rifrazione"])
    C4 --> U6
    U7(["componenti acusto-ottici"])
    C4 --> U7
