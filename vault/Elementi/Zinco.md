...
gruppo: 12
periodo: 4
posizione_cronologica: 11
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, metallo-di-transizione, epoca/antichita, secolo/XaC]
aliases: [Zn, Zinc]
---
...
In Europa lo zinco arriva prima come merce che come conoscenza. Lingotti di zinco metallico indiano e cinese sbarcano a Londra già nel 1513, e nei secoli successivi il metallo orientale resta un articolo costoso da importare. Solo nel 1738 William Champion brevetta in Inghilterra un procedimento a storte, e nel 1746 Andreas Marggraf pubblica a Berlino l'isolamento dello zinco puro; lo svedese Anton von Swab lo aveva ottenuto quattro anni prima. Fra la tecnica indiana e quella europea corrono, a essere generosi, otto secoli.
...
flowchart LR
    E["Zinco"]
    C1["Ossido di zinco<br/>ZnO"]
    E --> C1
    U1(["filtro fisico nelle creme solari"])
    C1 --> U1
    U2(["attivatore nella vulcanizzazione della gomma"])
    C1 --> U2
    U3(["pomate dermatologiche"])
    C1 --> U3
    C2["Solfuro di zinco<br/>ZnS"]
    E --> C2
    U4(["schermi fluorescenti"])
    C2 --> U4
    U5(["pigmenti bianchi"])
    C2 --> U5
    U6(["rivelatori di scintillazione"])
    C2 --> U6
    C3["Cloruro di zinco<br/>ZnCl2"]
    E --> C3
    U7(["flussante per saldature"])
    C3 --> U7
    U8(["preservante del legno"])
    C3 --> U8
    U9(["elettrolita nelle pile a secco"])
    C3 --> U9
