...
anno_scoperta: 1802
anno_stimato: false
scopritori: [William Hyde Wollaston]
epoca: L'età dell'elettrolisi
categoria: metallo_di_transizione
gruppo: 10
periodo: 5
posizione_cronologica: 42
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, metallo-di-transizione, epoca/elettrolisi, secolo/XIX]
aliases: [Pd, Palladium]
---
...
flowchart LR
    E["Palladio"]
    C1["Cloruro di palladio<br/>PdCl2"]
    E --> C1
    U1(["catalisi industriale"])
    C1 --> U1
    U2(["placcatura elettronica"])
    C1 --> U2
    U3(["rivelatori di monossido di carbonio"])
    C1 --> U3
    C2["Acetato di palladio<br/>Pd(CH3COO)2"]
    E --> C2
    U4(["catalizzatore per accoppiamenti incrociati"])
    C2 --> U4
    U5(["sintesi farmaceutica"])
    C2 --> U5
    C3["Idruro di palladio<br/>PdHx"]
    E --> C3
    U6(["purificazione dell'idrogeno"])
    C3 --> U6
    U7(["stoccaggio dell'idrogeno"])
    C3 --> U7
