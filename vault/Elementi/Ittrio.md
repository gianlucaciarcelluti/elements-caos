...
flowchart LR
    E["Ittrio"]
    C1["Ossido di ittrio (ittria)<br/>Y2O3"]
    E --> C1
    U1(["fosfori rossi per schermi e lampade"])
    C1 --> U1
    U2(["ceramiche e rivestimenti refrattari"])
    C1 --> U2
    C2["Granato di ittrio e alluminio<br/>Y3Al5O12"]
    E --> C2
    U3(["cristallo attivo dei laser Nd:YAG"])
    C2 --> U3
    U4(["gemme sintetiche"])
    C2 --> U4
    C3["Ossido di ittrio, bario e rame<br/>YBa2Cu3O7"]
    E --> C3
    U5(["superconduttore ad alta temperatura critica"])
    C3 --> U5
    C4["Gadolinite<br/>Y2FeBe2Si2O10"]
    E --> C4
    U6(["minerale storico di partenza delle terre rare"])
    C4 --> U6
