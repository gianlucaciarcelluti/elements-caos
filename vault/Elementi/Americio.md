...
anno_scoperta: 1944
anno_stimato: false
scopritori: [Glenn Seaborg, Ralph Arthur James, Leon Owen Morgan, Albert Ghiorso]
epoca: Era nucleare
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 94
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, attinide, epoca/nucleare, secolo/XX]
aliases: [Am, Americium]
---
...
flowchart LR
    E["Americio"]
    C1["Biossido di americio<br/>AmO2"]
    E --> C1
    U1(["rivelatori di fumo a ionizzazione"])
    C1 --> U1
    U2(["misuratori industriali"])
    C1 --> U2
    C2["Sorgente americio-berillio<br/>Am-Be"]
    E --> C2
    U3(["sorgenti di neutroni"])
    C2 --> U3
    U4(["prospezione petrolifera"])
    C2 --> U4
