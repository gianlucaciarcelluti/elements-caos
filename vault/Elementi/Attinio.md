...
anno_scoperta: 1899
anno_stimato: false
scopritori: [André-Louis Debierne]
epoca: Spettroscopia e radioattività
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 82
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, attinide, epoca/spettroscopia, secolo/XIX]
aliases: [Ac, Actinium]
---
...
flowchart LR
    E["Attinio"]
    C1["Ossido di attinio<br/>Ac2O3"]
    E --> C1
    U1(["sorgenti di neutroni con berillio"])
    C1 --> U1
    U2(["ricerca"])
    C1 --> U2
    C2["Attinio-225<br/>225Ac"]
    E --> C2
    U3(["terapia alfa mirata dei tumori"])
    C2 --> U3
