...
anno_scoperta: 1798
anno_stimato: false
scopritori: [Louis Nicolas Vauquelin]
epoca: Chimica pneumatica
categoria: metallo_alcalino_terroso
gruppo: 2
periodo: 2
posizione_cronologica: 39
tempo_lettura: 4
...
flowchart LR
    E["Berillio"]
    C1["Berillo<br/>Be3Al2Si6O18"]
    E --> C1
    U1(["principale minerale di berillio"])
    C1 --> U1
    U2(["smeraldo e acquamarina come gemme"])
    C1 --> U2
    C2["Ossido di berillio<br/>BeO"]
    E --> C2
    U3(["ceramica isolante ad altissima conducibilità termica"])
    C2 --> U3
    C3["Rame al berillio<br/>CuBe"]
    E --> C3
    U4(["utensili antiscintilla"])
    C3 --> U4
    U5(["contatti elettrici a lunga durata"])
    C3 --> U5
    C4["Cloruro di berillio<br/>BeCl2"]
    E --> C4
    U6(["precursore per la produzione del metallo"])
    C4 --> U6
