...
flowchart LR
    E["Tungsteno"]
    C1["Carburo di tungsteno<br/>WC"]
    E --> C1
    U1(["utensili da taglio e punte da trapano"])
    C1 --> U1
    U2(["parti resistenti all'usura"])
    C1 --> U2
    C2["Triossido di tungsteno<br/>WO3"]
    E --> C2
    U3(["intermedio per la produzione del metallo"])
    C2 --> U3
    U4(["vetri elettrocromici"])
    C2 --> U4
    C3["Wolframite<br/>(Fe,Mn)WO4"]
    E --> C3
    U5(["principale minerale di partenza"])
    C3 --> U5
    C4["Esafluoruro di tungsteno<br/>WF6"]
    E --> C4
    U6(["deposizione dei contatti nei circuiti integrati"])
    C4 --> U6
