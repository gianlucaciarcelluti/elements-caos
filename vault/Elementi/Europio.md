...
anno_scoperta: 1901
anno_stimato: false
scopritori: [Eugène-Anatole Demarçay]
epoca: Spettroscopia e radioattività
categoria: lantanide
gruppo: 3
periodo: 6
posizione_cronologica: 84
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, lantanide, epoca/spettroscopia, secolo/XX]
aliases: [Eu, Europium]
---
...
flowchart LR
    E["Europio"]
    C1["Ossido di europio<br/>Eu2O3"]
    E --> C1
    U1(["fosfori rossi per schermi e lampade"])
    C1 --> U1
    U2(["inchiostri di sicurezza"])
    C1 --> U2
    C2["Alluminato di bario e magnesio drogato all'europio<br/>BaMgAl10O17:Eu"]
    E --> C2
    U3(["fosfori blu per lampade fluorescenti"])
    C2 --> U3
    C3["Solfato di europio(II)<br/>EuSO4"]
    E --> C3
    U4(["chimica dello stato divalente"])
    C3 --> U4
    U5(["ricerca sui fosfori"])
    C3 --> U5
