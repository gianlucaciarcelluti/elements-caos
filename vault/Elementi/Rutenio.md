...
flowchart LR
    E["Rutenio"]
    C1["Biossido di rutenio<br/>RuO2"]
    E --> C1
    U1(["resistori a film spesso"])
    C1 --> U1
    U2(["anodi per la produzione di cloro"])
    C1 --> U2
    C2["Tricloruro di rutenio<br/>RuCl3"]
    E --> C2
    U3(["precursore dei catalizzatori"])
    C2 --> U3
    U4(["sintesi di complessi organometallici"])
    C2 --> U4
    C3["Tetrossido di rutenio<br/>RuO4"]
    E --> C3
    U5(["ossidazioni in chimica organica"])
    C3 --> U5
    U6(["rivelazione delle impronte digitali latenti"])
    C3 --> U6
