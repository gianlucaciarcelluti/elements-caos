...
flowchart LR
    ...
    C1["Acqua<br/>H2O"]
    E --> C1
    U1(["solvente universale della biochimica"])
    C1 --> U1
    U2(["base della vita sulla Terra"])
    C1 --> U2
    C2["Ammoniaca<br/>NH3"]
    E --> C2
    U3(["fertilizzanti azotati"])
    C2 --> U3
    U4(["intermedio della chimica industriale"])
    C2 --> U4
    C3["Metano<br/>CH4"]
    E --> C3
    U5(["combustibile"])
    C3 --> U5
    U6(["materia prima per la produzione di idrogeno"])
    C3 --> U6
    C4["Perossido di idrogeno<br/>H2O2"]
    E --> C4
    U7(["disinfettante"])
    C4 --> U7
    U8(["sbiancante"])
