...
flowchart LR
    E["Xenon"]
    C1["Tetrafluoruro di xeno<br/>XeF4"]
    E --> C1
    U1(["agente fluorurante"])
    C1 --> U1
    U2(["chimica dei gas nobili"])
    C1 --> U2
    C2["Xeno gassoso<br/>Xe"]
    E --> C2
    U3(["lampade ad arco"])
    C2 --> U3
    U4(["propulsione ionica"])
    C2 --> U4
    U5(["anestesia"])
    C2 --> U5
    C3["Xeno liquido<br/>Xe"]
    E --> C3
    U6(["rivelatori per la ricerca sulla materia oscura"])
    C3 --> U6
