...
anno_scoperta: 1950
anno_stimato: false
scopritori: [Stanley Gerald Thompson, Kenneth Street Jr., Albert Ghiorso, Glenn Seaborg]
epoca: Era nucleare
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 98
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, attinide, epoca/nucleare, secolo/XX]
aliases: [Cf, Californium]
---
...
flowchart LR
    E["Californio"]
    C1["Californio-252<br/>252Cf"]
    E --> C1
    U1(["sorgenti di neutroni"])
    C1 --> U1
    U2(["avviamento dei reattori"])
    C1 --> U2
    U3(["analisi per attivazione"])
    C1 --> U3
    C2["Ossido di californio<br/>Cf2O3"]
    E --> C2
    U4(["forma chimica delle sorgenti sigillate"])
    C2 --> U4
