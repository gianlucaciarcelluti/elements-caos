...
anno_scoperta: 1755
anno_stimato: false
scopritori: [Joseph Black]
epoca: Chimica pneumatica
categoria: metallo_alcalino_terroso
gruppo: 2
periodo: 3
posizione_cronologica: 22
tempo_lettura: 5
ha_approfondimento: false
tags: [elemento, metallo-alcalino-terroso, epoca/pneumatica, secolo/XVIII]
...
flowchart LR
    E["Magnesio"]
    C1["Ossido di magnesio<br/>MgO"]
    E --> C1
    U1(["rivestimenti refrattari per forni siderurgici"])
    C1 --> U1
    U2(["integratore alimentare"])
    C1 --> U2
    C2["Solfato di magnesio<br/>MgSO4"]
    E --> C2
    U3(["sale inglese per bagni e agricoltura"])
    C2 --> U3
    U4(["trattamento dell'eclampsia"])
    C2 --> U4
    C3["Idrossido di magnesio<br/>Mg(OH)2"]
    E --> C3
    U5(["latte di magnesia come antiacido e lassativo"])
    C3 --> U5
    U6(["ritardante di fiamma"])
    C3 --> U6
    C4["Clorofilla a<br/>C55H72MgN4O5"]
    E --> C4
    U7(["cattura della luce nella fotosintesi"])
    C4 --> U7
