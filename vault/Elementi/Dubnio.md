...
flowchart TB
    S["Tantalio<br/>Ta"]
    S -->|stesso gruppo| C
    C["Dubnio<br/>Db · Z=105"]
    L["Rutherfordio<br/>Rf"]
    L -->|stesso periodo| C
    R["Seaborgio<br/>Sg"]
    C -->|stesso periodo| R
...
flowchart LR
    E["Dubnio"]
    C1["Pentacloruro di dubnio<br/>DbCl₅"]
    E --> C1
    U1(["cromatografia in fase gassosa"])
    C1 --> U1
    U2(["confronto con i pentacloruri di niobio e tantalio"])
    C1 --> U2
    C2["Ossifluoruro di dubnio<br/>DbOF₄⁻"]
    E --> C2
    U3(["esperimenti di estrazione in soluzione nitrico-fluoridrica"])
    C2 --> U3
    C3["Dubnio-268<br/>268Db"]
    E --> C3
    U4(["esperimenti di chimica in soluzione acquosa"])
    C3 --> U4
