...
anno_scoperta: 1787
anno_stimato: false
scopritori: [Louis-Bernard Guyton de Morveau, Antoine-Laurent Lavoisier, Claude Louis Berthollet, Antoine François de Fourcroy]
epoca: Chimica pneumatica
categoria: semimetallo
gruppo: 13
periodo: 2
posizione_cronologica: 32
tempo_lettura: 5
ha_approfondimento: false
tags: [elemento, semimetallo, epoca/pneumatica, secolo/XVIII]
aliases: [B, Boron]
---
...
flowchart LR
    E["Boro"]
    C1["Borace<br/>Na2B4O7·10H2O"]
    E --> C1
    U1(["fondente per la saldatura dei metalli"])
    C1 --> U1
    U2(["detergenti e sbiancanti"])
    C1 --> U2
    C2["Acido borico<br/>H3BO3"]
    E --> C2
    U3(["antisettico blando"])
    C2 --> U3
    U4(["materia prima per il vetro borosilicato"])
    C2 --> U4
    C3["Carburo di boro<br/>B4C"]
    E --> C3
    U5(["corazzature balistiche"])
    C3 --> U5
    U6(["abrasivi e barre di controllo nucleari"])
    C3 --> U6
    C4["Nitruro di boro<br/>BN"]
    E --> C4
    U7(["lubrificante ad alta temperatura"])
    C4 --> U7
    U8(["abrasivo nella forma cubica"])
    C4 --> U8
