...
flowchart LR
    E["Copernicio"]
    C1["Copernicio-283<br/>283Cn"]
    E --> C1
    U1(["esperimenti di adsorbimento su superficie d'oro"])
    C1 --> U1
    C2["Copernicio-285<br/>285Cn"]
    E --> C2
    U2(["anello delle catene di decadimento del flerovio e degli elementi più pesanti"])
    C2 --> U2
