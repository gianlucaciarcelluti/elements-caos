...
flowchart LR
    E["Disprosio"]
    C1["Titanato di disprosio<br/>Dy2TiO5"]
    E --> C1
    U1(["barre di controllo dei reattori nucleari"])
    C1 --> U1
    C2["Terfenol-D<br/>Tb0.3Dy0.7Fe2"]
    E --> C2
    U2(["attuatori magnetostrittivi"])
    C2 --> U2
    U3(["sonar"])
    C2 --> U3
    C3["Ossido di disprosio<br/>Dy2O3"]
    E --> C3
    U4(["additivo per magneti permanenti"])
    C3 --> U4
    U5(["lampade a ioduri metallici"])
    C3 --> U5
