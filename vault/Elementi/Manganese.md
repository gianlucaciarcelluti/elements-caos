...
flowchart LR
    E["Manganese"]
    C1["Biossido di manganese (pirolusite)<br/>MnO2"]
    E --> C1
    U1(["catodo delle pile alcaline"])
    C1 --> U1
    U2(["decolorante per il vetro"])
    C1 --> U2
    U3(["pigmento nero"])
    C1 --> U3
    C2["Permanganato di potassio<br/>KMnO4"]
    E --> C2
    U4(["ossidante da laboratorio"])
    C2 --> U4
    U5(["disinfettante e trattamento delle acque"])
    C2 --> U5
    C3["Solfato di manganese<br/>MnSO4"]
    E --> C3
    U6(["integratore per mangimi e fertilizzanti"])
    C3 --> U6
    C4["Ossido di litio, nichel, manganese e cobalto<br/>LiNiMnCoO2"]
    E --> C4
    U7(["catodo delle batterie per auto elettriche"])
    C4 --> U7
