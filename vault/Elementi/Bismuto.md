...
flowchart LR
    E["Bismuto"]
    C1["Subsalicilato di bismuto<br/>C7H5BiO4"]
    E --> C1
    U1(["antidiarroico e antiacido"])
    C1 --> U1
    U2(["terapia contro l'Helicobacter pylori"])
    C1 --> U2
    C2["Ossicloruro di bismuto<br/>BiOCl"]
    E --> C2
    U3(["pigmento perlescente nei cosmetici"])
    C2 --> U3
    U4(["vernici a effetto madreperla"])
    C2 --> U4
    C3["Bismutinite<br/>Bi2S3"]
    E --> C3
    U5(["principale minerale di bismuto"])
    C3 --> U5
