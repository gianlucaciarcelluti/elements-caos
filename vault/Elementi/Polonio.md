...
flowchart LR
    E["Polonio"]
    C1["Polonio-210<br/>210Po"]
    E --> C1
    U1(["sorgenti termiche"])
    C1 --> U1
    U2(["eliminatori di cariche elettrostatiche"])
    C1 --> U2
    C2["Sorgente polonio-berillio<br/>Po-Be"]
    E --> C2
