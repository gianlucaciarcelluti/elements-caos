...
flowchart LR
    E["Niobio"]
    C1["Pentossido di niobio<br/>Nb2O5"]
    E --> C1
    U1(["vetri ottici ad alto indice di rifrazione"])
    C1 --> U1
    U2(["precursore del metallo e delle leghe"])
    C1 --> U2
    C2["Niobato di litio<br/>LiNbO3"]
    E --> C2
    U3(["modulatori ottici"])
    C2 --> U3
    U4(["filtri a onde acustiche superficiali"])
    C2 --> U4
    C3["Carburo di niobio<br/>NbC"]
    E --> C3
    U5(["inserti per utensili da taglio"])
    C3 --> U5
    U6(["materiali refrattari"])
    C3 --> U6
