...
gruppo: 17
periodo: 7
posizione_cronologica: 118
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, alogeno, epoca/nucleare, secolo/XXI]
aliases: [Ts, Tennessine]
---
...
flowchart LR
    E["Tennesso"]
    C1["Tennesso-293<br/>293Ts"]
    E --> C1
    U1(["l'isotopo osservato cinque volte nell'esperimento del 2010"])
    C1 --> U1
    C2["Trifluoruro di tennesso<br/>TsF₃"]
    E --> C2
    U2(["composto previsto con geometria diversa da quella degli altri alogeni, mai preparato"])
    C2 --> U2
