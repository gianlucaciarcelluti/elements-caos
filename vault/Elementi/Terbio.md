...
flowchart LR
    E["Terbio"]
    C1["Ossido di terbio<br/>Tb4O7"]
    E --> C1
    U1(["fosfori verdi"])
    C1 --> U1
    U2(["precursore dei composti di terbio"])
    C1 --> U2
    C2["Terfenol-D<br/>Tb0.3Dy0.7Fe2"]
    E --> C2
    U3(["attuatori magnetostrittivi"])
    C2 --> U3
    U4(["sonar navali"])
    C2 --> U4
    C3["Fluoruro di terbio(IV)<br/>TbF4"]
    E --> C3
    U5(["agente fluorurante"])
    C3 --> U5
    U6(["chimica dello stato +4"])
    C3 --> U6
