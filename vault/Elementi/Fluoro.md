...
tags: [elemento, alogeno, epoca/pneumatica, secolo/XVIII]
aliases: [F, Fluorine]
---
...
La situazione è tanto chiara nella teoria quanto impraticabile nei fatti. Nel 1810 André-Marie Ampère suggerisce a Humphry Davy che quell'acido debba contenere un elemento nuovo, analogo al cloro, e propone di chiamarlo fluorine; Davy accoglie l'idea e prova a isolarlo, senza riuscirci. Per settantasei anni il fluoro esiste come voce nelle tabelle degli elementi, con un nome, un posto e nessun campione: un elemento dedotto e mai visto.

Il problema è che per liberare il fluoro bisogna manipolare l'acido fluoridrico, che attacca il vetro, la pelle e le ossa, e che una volta liberato il fluoro reagisce con l'apparato che dovrebbe contenerlo. I chimici che ci provarono nell'Ottocento furono chiamati martiri del fluoro, e l'espressione non è retorica: il belga Paulin Louyet e il francese Jérôme Nicklès morirono nel tentativo, gli irlandesi Thomas e George Knox riportarono gravi avvelenamenti da acido fluoridrico, e l'inglese George Gore vide il proprio apparato distrutto da una serie di esplosioni.
...
flowchart LR
    E["Fluoro"]
    C1["Acido fluoridrico<br/>HF"]
    E --> C1
    U1(["incisione del vetro"])
    C1 --> U1
    U2(["precursore dei composti fluorurati"])
    C1 --> U2
    C2["Politetrafluoroetilene (teflon)<br/>(C2F4)n"]
    E --> C2
    U3(["rivestimenti antiaderenti"])
    C2 --> U3
    U4(["guarnizioni e isolanti"])
    C2 --> U4
    C3["Esafluoruro di uranio<br/>UF6"]
    E --> C3
    U5(["arricchimento dell'uranio"])
    C3 --> U5
    C4["Fluoruro di sodio<br/>NaF"]
    E --> C4
    U6(["prevenzione della carie"])
    C4 --> U6
    U7(["fluorurazione delle acque"])
    C4 --> U7
