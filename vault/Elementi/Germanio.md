...
anno_scoperta: 1886
anno_stimato: false
scopritori: [Clemens Winkler]
epoca: Spettroscopia e radioattività
categoria: semimetallo
gruppo: 14
periodo: 4
posizione_cronologica: 74
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, semimetallo, epoca/spettroscopia, secolo/XIX]
aliases: [Ge, Germanium]
---
...
flowchart LR
    E["Germanio"]
    C1["Biossido di germanio<br/>GeO2"]
    E --> C1
    U1(["nucleo delle fibre ottiche"])
    C1 --> U1
    U2(["catalizzatore per il PET"])
    C1 --> U2
    U3(["vetri ottici"])
    C1 --> U3
    C2["Tetracloruro di germanio<br/>GeCl4"]
    E --> C2
    U4(["intermedio per le fibre ottiche"])
    C2 --> U4
    U5(["sintesi di composti organogermanici"])
    C2 --> U5
    C3["Lega silicio-germanio<br/>SiGe"]
    E --> C3
    U6(["circuiti ad alta frequenza"])
    C3 --> U6
    U7(["dispositivi termoelettrici"])
    C3 --> U7
