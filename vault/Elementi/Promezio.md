...
anno_scoperta: 1945
anno_stimato: false
scopritori: [Jacob Marinsky, Lawrence Glendenin, Charles Coryell]
epoca: Era nucleare
categoria: lantanide
gruppo: 3
periodo: 6
posizione_cronologica: 96
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, lantanide, epoca/nucleare, secolo/XX]
aliases: [Pm, Promethium]
---
...
flowchart LR
    E["Promezio"]
    C1["Cloruro di promezio<br/>PmCl3"]
    E --> C1
    U1(["forma di riferimento per lo studio dell'elemento"])
    C1 --> U1
    C2["Promezio-147<br/>147Pm"]
    E --> C2
    U2(["batterie nucleari"])
    C2 --> U2
    U3(["vernici luminescenti"])
    C2 --> U3
    U4(["misuratori di spessore"])
    C2 --> U4
