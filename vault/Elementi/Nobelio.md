...
anno_scoperta: 1958
anno_stimato: false
scopritori: [Albert Ghiorso, Torbjørn Sikkeland, John R. Walton, Glenn Seaborg]
epoca: Era nucleare
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 102
tempo_lettura: 5
...
flowchart LR
    E["Nobelio"]
    C1["Ione nobelio(II)<br/>No²⁺"]
    E --> C1
    U1(["studi di coprecipitazione con i metalli alcalino-terrosi"])
    C1 --> U1
    C2["Ione nobelio(III)<br/>No³⁺"]
    E --> C2
    U2(["misura del potenziale di ossidazione alla fine della serie degli attinidi"])
    C2 --> U2
    C3["Nobelio-255<br/>255No"]
    E --> C3
    U3(["esperimenti di chimica rapida su pochi atomi"])
    C3 --> U3
