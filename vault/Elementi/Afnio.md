...
flowchart LR
    E["Afnio"]
    C1["Ossido di afnio<br/>HfO2"]
    E --> C1
    U1(["dielettrico dei transistor"])
    C1 --> U1
    U2(["rivestimenti ottici"])
    C1 --> U2
    U3(["ceramiche refrattarie"])
    C1 --> U3
    C2["Afnio metallico<br/>Hf"]
    E --> C2
    U4(["barre di controllo per reattori navali"])
    C2 --> U4
    C3["Carburo di afnio<br/>HfC"]
    E --> C3
    U5(["materiali con i più alti punti di fusione noti"])
    C3 --> U5
