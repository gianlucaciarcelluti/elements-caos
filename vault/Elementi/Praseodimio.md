...
```mermaid
timeline
    title Scoperta del Praseodimio
...
flowchart LR
    E["Praseodimio"]
    C1["Ossido di praseodimio<br/>Pr6O11"]
    E --> C1
    U1(["pigmento giallo per ceramiche"])
    C1 --> U1
    U2(["vetri da saldatore"])
    C1 --> U2
    U3(["catalizzatori"])
    C1 --> U3
    C2["Lega didimio-ferro-boro<br/>(Nd,Pr)2Fe14B"]
    E --> C2
    U4(["magneti permanenti"])
    C2 --> U4
    U5(["motori elettrici"])
    C2 --> U5
    C3["Lega magnesio-praseodimio<br/>Mg-Pr"]
    E --> C3
    U6(["strutture leggere ad alta resistenza"])
    C3 --> U6
