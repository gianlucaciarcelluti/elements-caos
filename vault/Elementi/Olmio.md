...
anno_scoperta: 1878
anno_stimato: false
scopritori: [Jacques-Louis Soret, Marc Delafontaine]
epoca: Spettroscopia e radioattività
categoria: lantanide
gruppo: 3
periodo: 6
posizione_cronologica: 67
tempo_lettura: 4
...
flowchart LR
    E["Olmio"]
    C1["Ossido di olmio<br/>Ho2O3"]
    E --> C1
    U1(["colorante per vetri e zirconia"])
    C1 --> U1
    U2(["standard di taratura spettrofotometrica"])
    C1 --> U2
    C2["Cristallo Ho:YAG<br/>Ho:Y3Al5O12"]
    E --> C2
    U3(["laser chirurgici"])
    C2 --> U3
    U4(["litotrissia"])
    C2 --> U4
    U5(["chirurgia della prostata"])
    C2 --> U5
