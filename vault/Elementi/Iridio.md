...
flowchart LR
    E["Iridio"]
    C1["Diossido di iridio<br/>IrO2"]
    E --> C1
    U1(["elettrodi per elettrolisi"])
    C1 --> U1
    U2(["produzione industriale di cloro"])
    C1 --> U2
    C2["Tricloruro di iridio<br/>IrCl3"]
    E --> C2
    U3(["precursore dei catalizzatori"])
    C2 --> U3
    U4(["sintesi di complessi luminescenti"])
    C2 --> U4
    C3["Esacloroiridato di sodio<br/>Na2IrCl6"]
    E --> C3
    U5(["il sale rosso scuro della scoperta"])
    C3 --> U5
    U6(["raffinazione dell'iridio"])
    C3 --> U6
