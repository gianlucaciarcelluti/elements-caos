...
flowchart LR
    E["Itterbio"]
    C1["Ossido di itterbio<br/>Yb2O3"]
    E --> C1
    U1(["drogaggio di laser in fibra"])
    C1 --> U1
    U2(["vetri e ceramiche speciali"])
    C1 --> U2
    C2["Fluoruro di itterbio<br/>YbF3"]
    E --> C2
    U3(["riempitivo radiopaco per otturazioni dentali"])
    C2 --> U3
    C3["Ioduro di itterbio(II)<br/>YbI2"]
    E --> C3
    U4(["riducente in sintesi organica"])
    C3 --> U4
