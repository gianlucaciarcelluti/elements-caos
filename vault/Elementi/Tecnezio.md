...
anno_scoperta: 1937
anno_stimato: false
scopritori: [Carlo Perrier, Emilio Segrè]
...
flowchart LR
    E["Tecnezio"]
    C1["Pertecnetato di sodio<br/>NaTcO4"]
    E --> C1
    U1(["radiofarmaco di base per la scintigrafia"])
    C1 --> U1
    C2["Tecnezio-99m<br/>99mTc"]
    E --> C2
    U2(["diagnostica per immagini in medicina nucleare"])
    C2 --> U2
    C3["Generatore molibdeno-tecnezio<br/>99Mo/99mTc"]
    E --> C3
    U3(["produzione ospedaliera quotidiana del radiofarmaco"])
    C3 --> U3
