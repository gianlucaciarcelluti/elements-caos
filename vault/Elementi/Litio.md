...
anno_scoperta: 1817
anno_stimato: false
scopritori: [Johan August Arfwedson]
epoca: L'età dell'elettrolisi
categoria: metallo_alcalino
gruppo: 1
periodo: 2
posizione_cronologica: 51
tempo_lettura: 5
...
```mermaid
timeline
    title Scoperta del Litio
    1817 : Scoperta : Johan August Arfwedson
    1821 : Isolamento
```
...
flowchart LR
    E["Litio"]
    C1["Carbonato di litio<br/>Li2CO3"]
    E --> C1
    U1(["materiali per batterie"])
    C1 --> U1
    U2(["stabilizzatore dell'umore"])
    C1 --> U2
    U3(["vetri e ceramiche"])
    C1 --> U3
    C2["Idrossido di litio<br/>LiOH"]
    E --> C2
    U4(["catodi delle batterie agli ioni di litio"])
    C2 --> U4
    U5(["grassi lubrificanti"])
    C2 --> U5
    U6(["assorbimento dell'anidride carbonica negli ambienti chiusi"])
    C2 --> U6
    C3["Cloruro di litio<br/>LiCl"]
    E --> C3
    U7(["produzione elettrolitica del metallo"])
    C3 --> U7
    U8(["deumidificanti"])
    C3 --> U8
    U9(["flussi per saldatura"])
    C3 --> U9
