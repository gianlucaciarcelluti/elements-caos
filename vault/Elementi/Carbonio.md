...
flowchart LR
    E["Carbonio"]
    C1["Anidride carbonica<br/>CO2"]
    E --> C1
    U1(["bevande gassate"])
    C1 --> U1
    U2(["estintori"])
    C1 --> U2
    U3(["fotosintesi e ciclo del carbonio"])
    C1 --> U3
    C2["Monossido di carbonio<br/>CO"]
    E --> C2
    U4(["riduzione dei minerali di ferro in altoforno"])
    C2 --> U4
    U5(["sintesi industriale del metanolo"])
    C2 --> U5
    C3["Carbonato di calcio<br/>CaCO3"]
    E --> C3
    U6(["calce e cemento"])
    C3 --> U6
    U7(["carta e vernici"])
    C3 --> U7
    U8(["correzione dei suoli acidi"])
    C3 --> U8
    C4["Metano<br/>CH4"]
    E --> C4
    U9(["combustibile domestico e industriale"])
    C4 --> U9
    U10(["materia prima per la chimica di sintesi"])
    C4 --> U10
