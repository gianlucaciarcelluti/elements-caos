...
gruppo: 15
periodo: 4
posizione_cronologica: 13
tempo_lettura: 5
ha_approfondimento: false
tags: [elemento, semimetallo, epoca/antichita, secolo/III]
aliases: [As, Arsenic]
---
...
flowchart LR
    E["Arsenico"]
    C1["Triossido di arsenico<br/>As2O3"]
    E --> C1
    U1(["farmaco contro la leucemia promielocitica acuta"])
    C1 --> U1
    U2(["storico veleno e preservante"])
    C1 --> U2
    U3(["decolorante nell'industria del vetro"])
    C1 --> U3
    C2["Orpimento<br/>As2S3"]
    E --> C2
    U4(["pigmento giallo oro"])
    C2 --> U4
    U5(["depilazione delle pelli in conceria"])
    C2 --> U5
    C3["Arseniuro di gallio<br/>GaAs"]
    E --> C3
    U6(["circuiti a microonde"])
    C3 --> U6
    U7(["diodi laser e LED infrarossi"])
    C3 --> U7
    U8(["celle solari ad alta efficienza"])
    C3 --> U8
