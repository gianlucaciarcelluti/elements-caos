...
anno_scoperta: 1751
anno_stimato: false
scopritori: [Axel Fredrik Cronstedt]
epoca: Chimica pneumatica
categoria: metallo_di_transizione
gruppo: 10
periodo: 4
posizione_cronologica: 21
tempo_lettura: 5
...
flowchart LR
    E["Nichel"]
    C1["Solfato di nichel<br/>NiSO4"]
    E --> C1
    U1(["bagni galvanici per la nichelatura"])
    C1 --> U1
    U2(["precursore dei catodi per batterie"])
    C1 --> U2
    C2["Tetracarbonile di nichel<br/>Ni(CO)4"]
    E --> C2
    U3(["raffinazione del metallo con il processo Mond"])
    C2 --> U3
    C3["Ossido-idrossido di nichel<br/>NiO(OH)"]
    E --> C3
    U4(["elettrodo positivo delle batterie nichel-metallo idruro"])
    C3 --> U4
    C4["Niccolite<br/>NiAs"]
    E --> C4
    U5(["minerale storico da cui fu ricavato il primo nichel"])
    C4 --> U5
