...
flowchart LR
    E["Uranio"]
    C1["Biossido di uranio<br/>UO2"]
    E --> C1
    U1(["pastiglie di combustibile nucleare"])
    C1 --> U1
    C2["Esafluoruro di uranio<br/>UF6"]
    E --> C2
    U2(["arricchimento isotopico per centrifugazione"])
    C2 --> U2
    C3["Diuranato di sodio (yellowcake)<br/>Na2U2O7"]
    E --> C3
    U3(["concentrato commerciale del minerale"])
    C3 --> U3
    U4(["pigmento giallo per ceramiche"])
    C3 --> U4
    C4["Nitrato di uranile<br/>UO2(NO3)2"]
    E --> C4
    U5(["ritrattamento del combustibile"])
    C4 --> U5
    U6(["colorante per microscopia"])
    C4 --> U6
