...
flowchart LR
    E["Hassio"]
    C1["Tetrossido di hassio<br/>HsO₄"]
    E --> C1
    U1(["cromatografia in fase gassosa"])
    C1 --> U1
    U2(["confronto con il tetrossido di osmio"])
    C1 --> U2
    C2["Hassato(VIII)<br/>[HsO₄(OH)₂]²⁻"]
    E --> C2
    U3(["reazione con gli idrossidi, confronto con osmati e rutenati"])
    C2 --> U3
    C3["Hassio-269<br/>269Hs"]
    E --> C3
    U4(["esperimenti di chimica in fase gassosa"])
    C3 --> U4
