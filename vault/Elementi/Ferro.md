...
flowchart LR
    ...
    C1["Ematite<br/>Fe2O3"]
    E --> C1
    U1(["minerale principale del ferro"])
    C1 --> U1
    U2(["pigmento rosso ocra"])
    C1 --> U2
    U3(["abrasivi per lucidatura"])
    C1 --> U3
    C2["Magnetite<br/>Fe3O4"]
    E --> C2
    U4(["minerale di ferro ad alta resa"])
    C2 --> U4
    U5(["ferriti magnetiche"])
    C2 --> U5
    U6(["brunitura protettiva"])
    C2 --> U6
