...
flowchart LR
    E["Roentgenio"]
    C1["Roentgenuro<br/>Rg⁻"]
    E --> C1
    U1(["anione previsto per analogia con l'auride, ritenuto poco stabile"])
    C1 --> U1
    C2["Roentgenio-282<br/>282Rg"]
    E --> C2
