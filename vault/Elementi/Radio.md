...
anno_scoperta: 1898
anno_stimato: false
scopritori: [Pierre Curie, Marie Curie]
...
flowchart LR
    E["Radio"]
    C1["Cloruro di radio<br/>RaCl2"]
    E --> C1
    U1(["prima forma purificata dell'elemento"])
    C1 --> U1
    U2(["sorgenti storiche"])
    C1 --> U2
    C2["Solfato di radio e solfuro di zinco<br/>RaSO4 + ZnS"]
    E --> C2
    U3(["vernici luminescenti storiche"])
    C2 --> U3
    C3["Radio-223 dicloruro<br/>223RaCl2"]
    E --> C3
    U4(["terapia delle metastasi ossee"])
    C3 --> U4
