...
flowchart LR
    E["Elio"]
    C1["Elio liquido<br/>He"]
    E --> C1
    U1(["raffreddamento dei magneti superconduttori"])
    C1 --> U1
    U2(["criogenia da laboratorio"])
    C1 --> U2
    C2["Miscela elio-ossigeno<br/>He-O2"]
    E --> C2
    U3(["respirazione in immersione profonda"])
    C2 --> U3
    U4(["terapie respiratorie"])
    C2 --> U4
