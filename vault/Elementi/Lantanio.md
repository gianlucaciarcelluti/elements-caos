...
flowchart LR
    E["Lantanio"]
    C1["Ossido di lantanio<br/>La2O3"]
    E --> C1
    U1(["vetri ottici ad alto indice di rifrazione"])
    C1 --> U1
    U2(["catalizzatori per raffineria"])
    C1 --> U2
    C2["Carbonato di lantanio<br/>La2(CO3)3"]
    E --> C2
    U3(["farmaco che lega i fosfati nell'insufficienza renale"])
    C2 --> U3
    C3["Lega LaNi5<br/>LaNi5"]
    E --> C3
    U4(["accumulo di idrogeno"])
    C3 --> U4
    U5(["elettrodi delle batterie nichel-metallo idruro"])
    C3 --> U5
