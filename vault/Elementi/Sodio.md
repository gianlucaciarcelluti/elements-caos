...
flowchart LR
    ...
    U1(["alimentazione"])
    C1 --> U1
    U2(["conservazione degli alimenti"])
    C1 --> U2
    U3(["industria chimica"])
    C1 --> U3
    C2["Idrossido di sodio<br/>NaOH"]
    E --> C2
    U4(["produzione di sapone e carta"])
    C2 --> U4
    U5(["industria tessile"])
    C2 --> U5
    C3["Bicarbonato di sodio<br/>NaHCO3"]
    E --> C3
    U6(["lievitazione in cucina"])
    C3 --> U6
    U7(["antiacido"])
    C3 --> U7
    U8(["pulizia domestica"])
    C3 --> U8
