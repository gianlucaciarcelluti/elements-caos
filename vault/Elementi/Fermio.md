...
flowchart LR
    E["Fermio"]
    C1["Fermio-257<br/>257Fm"]
    E --> C1
    U1(["ricerca sulla chimica degli attinidi al limite della serie"])
    C1 --> U1
    C2["Cloruro di fermio<br/>FmCl3"]
    E --> C2
    U2(["studi di comportamento chimico su pochi atomi"])
    C2 --> U2
