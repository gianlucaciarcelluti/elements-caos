...
anno_scoperta: 1969
anno_stimato: false
scopritori: [Georgy Flerov, Albert Ghiorso]
epoca: Era nucleare
categoria: metallo_di_transizione
gruppo: 4
periodo: 7
posizione_cronologica: 104
tempo_lettura: 5
ha_approfondimento: false
tags: [elemento, metallo-di-transizione, epoca/nucleare, secolo/XX]
aliases: [Rf, Rutherfordium]
---
...
```mermaid
timeline
    title Scoperta del Rutherfordio
...
flowchart LR
    E["Rutherfordio"]
    C1["Tetracloruro di rutherfordio<br/>RfCl₄"]
    E --> C1
    U1(["cromatografia in fase gassosa"])
    C1 --> U1
    U2(["confronto con i tetracloruri di zirconio e afnio"])
    C1 --> U2
    C2["Tetrabromuro di rutherfordio<br/>RfBr₄"]
    E --> C2
    U3(["studi di volatilità dei composti del gruppo 4"])
    C2 --> U3
    C3["Complessi fluorurati<br/>RfF₆²⁻"]
    E --> C3
    U4(["esperimenti di estrazione in soluzione acquosa"])
    C3 --> U4
