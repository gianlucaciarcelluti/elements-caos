...
flowchart LR
    E["Oro"]
    C1["Cloruro aurico<br/>AuCl3"]
    E --> C1
    U1(["doratura per via chimica"])
    C1 --> U1
    U2(["fotografia storica"])
    C1 --> U2
    U3(["catalisi in chimica organica"])
    C1 --> U3
    ...
    C2 --> U5
    C3["Oro colloidale<br/>Au"]
    E --> C3
    U6(["vetro rubino"])
    C3 --> U6
    U7(["test diagnostici rapidi"])
    C3 --> U7
    U8(["marcatura in microscopia elettronica"])
    C3 --> U8
