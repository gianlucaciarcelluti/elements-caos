...
flowchart LR
    E["Potassio"]
    C1["Cloruro di potassio<br/>KCl"]
    E --> C1
    U1(["fertilizzanti"])
    C1 --> U1
    U2(["sale dietetico"])
    C1 --> U2
    U3(["industria chimica"])
    C1 --> U3
    C2["Idrossido di potassio<br/>KOH"]
    E --> C2
    U4(["saponi molli e liquidi"])
    C2 --> U4
    U5(["elettroliti per batterie"])
    C2 --> U5
    U6(["produzione di biodiesel"])
    C2 --> U6
    C3["Nitrato di potassio<br/>KNO3"]
    E --> C3
    U7(["polvere da sparo"])
    C3 --> U7
    C3 --> U1
    U8(["conservazione delle carni"])
    C3 --> U8
    C4["Permanganato di potassio<br/>KMnO4"]
    E --> C4
    U9(["disinfettante"])
    C4 --> U9
    U10(["ossidante in sintesi organica"])
    C4 --> U10
    U11(["trattamento delle acque"])
    C4 --> U11
