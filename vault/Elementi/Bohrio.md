...
anno_scoperta: 1981
anno_stimato: false
scopritori: [Peter Armbruster, Gottfried Münzenberg]
epoca: Era nucleare
categoria: metallo_di_transizione
gruppo: 7
periodo: 7
posizione_cronologica: 107
tempo_lettura: 5
...
flowchart LR
    E["Bohrio"]
    C1["Ossicloruro di bohrio<br/>BhO₃Cl"]
    E --> C1
    U1(["cromatografia in fase gassosa"])
    C1 --> U1
    U2(["confronto con gli ossicloruri di tecnezio e renio"])
    C1 --> U2
    C2["Bohrio-267<br/>267Bh"]
    E --> C2
    U3(["esperimenti di chimica in fase gassosa"])
    C2 --> U3
    C3["Bohrio-270<br/>270Bh"]
    E --> C3
    U4(["studio della stabilità dei nuclei ricchi di neutroni"])
    C3 --> U4
