...
flowchart LR
    E["Seaborgio"]
    C1["Ossicloruro di seaborgio<br/>SgO₂Cl₂"]
    E --> C1
    U1(["cromatografia in fase gassosa"])
    C1 --> U1
    U2(["confronto di volatilità lungo il gruppo 6"])
    C1 --> U2
    C2["Esacarbonile di seaborgio<br/>Sg(CO)₆"]
    E --> C2
    U3(["dimostrazione dello stato di ossidazione zero"])
    C2 --> U3
    U4(["chimica metallorganica dei superpesanti"])
    C2 --> U4
    C3["Ossidoidrossido di seaborgio<br/>SgO₂(OH)₂"]
    E --> C3
    U5(["esperimenti di chimica in soluzione acquosa"])
    C3 --> U5
