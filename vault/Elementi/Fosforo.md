...
flowchart LR
    ...
    U3(["detergenti"])
    C1 --> U3
    C2["Fosfato di calcio<br/>Ca3(PO4)2"]
    E --> C2
    U4(["ossa e denti"])
    C2 --> U4
    U5(["roccia fosfatica per fertilizzanti"])
    C2 --> U5
    C3["Trisolfuro di tetrafosforo<br/>P4S3"]
    E --> C3
    U6(["capocchia dei fiammiferi"])
    C3 --> U6
