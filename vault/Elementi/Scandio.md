...
anno_scoperta: 1879
anno_stimato: false
scopritori: [Lars Fredrik Nilson]
epoca: Spettroscopia e radioattività
categoria: metallo_di_transizione
gruppo: 3
periodo: 4
posizione_cronologica: 69
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, metallo-di-transizione, epoca/spettroscopia, secolo/XIX]
aliases: [Sc, Scandium]
---
...
flowchart LR
    E["Scandio"]
    C1["Ossido di scandio<br/>Sc2O3"]
    E --> C1
    U1(["lampade a ioduri metallici"])
    C1 --> U1
    U2(["elettroliti per celle a combustibile"])
    C1 --> U2
    C2["Lega alluminio-scandio<br/>Al-Sc"]
    E --> C2
    U3(["strutture aeronautiche"])
    C2 --> U3
    U4(["telai sportivi ad alta resistenza"])
    C2 --> U4
    C3["Ioduro di scandio<br/>ScI3"]
    E --> C3
    U5(["lampade a scarica ad alta intensità"])
    C3 --> U5
