...
flowchart LR
    ...
    C1["Galena<br/>PbS"]
    E --> C1
    U1(["minerale principale del piombo"])
    C1 --> U1
    U2(["rilevatori a cristallo delle prime radio"])
    C1 --> U2
    C2["Ossido di piombo<br/>PbO2"]
    E --> C2
    U3(["piastre positive delle batterie al piombo-acido"])
    C2 --> U3
    C3["Biacca<br/>2PbCO3·Pb(OH)2"]
    E --> C3
    U4(["pigmento bianco per pittura"])
    C3 --> U4
    U5(["cosmetici storici, oggi vietati"])
    C3 --> U5
    C4["Piombo tetraetile<br/>Pb(C2H5)4"]
    E --> C4
    U6(["antidetonante per benzina, dismesso per tossicità"])
    C4 --> U6
