...
anno_scoperta: 1803
anno_stimato: false
scopritori: [Jöns Jacob Berzelius, Wilhelm Hisinger, Martin Heinrich Klaproth]
epoca: L'età dell'elettrolisi
categoria: lantanide
gruppo: 3
periodo: 6
posizione_cronologica: 44
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, lantanide, epoca/elettrolisi, secolo/XIX]
aliases: [Ce, Cerium]
---
...
timeline
    ...
    1803 : Scoperta : Jöns Jacob Berzelius, Wilhelm Hisinger, Martin Heinrich Klaproth
    1875 : Isolamento
```
...
flowchart LR
    E["Cerio"]
    C1["Ossido di cerio(IV)<br/>CeO2"]
    E --> C1
    U1(["lucidatura del vetro"])
    C1 --> U1
    U2(["convertitori catalitici"])
    C1 --> U2
    U3(["filtri per l'ultravioletto"])
    C1 --> U3
    C2["Nitrato ammonico cerico<br/>(NH4)2Ce(NO3)6"]
    E --> C2
    U4(["ossidante in chimica organica"])
    C2 --> U4
    U5(["titolazioni redox"])
    C2 --> U5
    C3["Ferrocerio<br/>FeCe"]
    E --> C3
    U6(["pietrine per accendini"])
    C3 --> U6
    U7(["inneschi a scintilla"])
    C3 --> U7
