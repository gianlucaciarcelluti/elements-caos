...
anno_scoperta: 1817
anno_stimato: false
scopritori: [Jöns Jacob Berzelius, Johan Gottlieb Gahn]
epoca: L'età dell'elettrolisi
categoria: non_metallo
gruppo: 16
periodo: 4
posizione_cronologica: 52
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, non-metallo, epoca/elettrolisi, secolo/XIX]
aliases: [Se, Selenium]
---
...
flowchart LR
    E["Selenio"]
    C1["Biossido di selenio<br/>SeO2"]
    E --> C1
    U1(["ossidante in sintesi organica"])
    C1 --> U1
    U2(["brunitura delle armi"])
    C1 --> U2
    U3(["pigmenti"])
    C1 --> U3
    C2["Solfuro di selenio<br/>SeS2"]
    E --> C2
    U4(["shampoo antiforfora"])
    C2 --> U4
    U5(["trattamento delle dermatiti seborroiche"])
    C2 --> U5
    C3["Selenito di sodio<br/>Na2SeO3"]
    E --> C3
    U6(["integrazione di mangimi e fertilizzanti"])
    C3 --> U6
    U7(["reagente analitico"])
    C3 --> U7
    C4["Seleniuro di rame, indio e gallio<br/>CuInGaSe2"]
    E --> C4
    U8(["celle solari a film sottile"])
    C4 --> U8
