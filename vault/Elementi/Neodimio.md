...
flowchart LR
    E["Neodimio"]
    C1["Lega neodimio-ferro-boro<br/>Nd2Fe14B"]
    E --> C1
    U1(["magneti permanenti"])
    C1 --> U1
    U2(["motori elettrici"])
    C1 --> U2
    U3(["generatori eolici"])
    C1 --> U3
    C2["Ossido di neodimio<br/>Nd2O3"]
    E --> C2
    U4(["colorante per vetri"])
    C2 --> U4
    U5(["precursore dei magneti"])
    C2 --> U5
    U6(["filtri ottici"])
    C2 --> U6
    C3["Cristallo Nd:YAG<br/>Nd:Y3Al5O12"]
    E --> C3
    U7(["laser industriali"])
    C3 --> U7
    U8(["laser medicali"])
    C3 --> U8
    U9(["ricerca sulla fusione"])
    C3 --> U9
