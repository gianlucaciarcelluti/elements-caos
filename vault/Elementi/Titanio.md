...
flowchart LR
    E["Titanio"]
    C1["Biossido di titanio<br/>TiO2"]
    E --> C1
    U1(["pigmento bianco per vernici e plastiche"])
    C1 --> U1
    U2(["filtro solare fisico"])
    C1 --> U2
    U3(["fotocatalizzatore"])
    C1 --> U3
    C2["Tetracloruro di titanio<br/>TiCl4"]
    E --> C2
    U4(["intermedio del processo Kroll"])
    C2 --> U4
    U5(["produzione del pigmento"])
    C2 --> U5
    C3["Ilmenite<br/>FeTiO3"]
    E --> C3
    U6(["principale minerale di partenza"])
    C3 --> U6
    C4["Nitruro di titanio<br/>TiN"]
    E --> C4
    U7(["rivestimenti dorati per utensili da taglio"])
    C4 --> U7
