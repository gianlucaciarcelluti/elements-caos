...
flowchart LR
    E["Gallio"]
    C1["Arseniuro di gallio<br/>GaAs"]
    E --> C1
    U1(["circuiti a microonde"])
    C1 --> U1
    U2(["celle solari per satelliti"])
    C1 --> U2
    U3(["diodi laser"])
    C1 --> U3
    C2["Nitruro di gallio<br/>GaN"]
    E --> C2
    U4(["LED blu e bianchi"])
    C2 --> U4
    U5(["elettronica di potenza"])
    C2 --> U5
    U6(["amplificatori a radiofrequenza"])
    C2 --> U6
    C3["Galinstano<br/>Ga-In-Sn"]
    E --> C3
    U7(["termometri senza mercurio"])
    C3 --> U7
    U8(["contatti elettrici liquidi"])
    C3 --> U8
