...
anno_scoperta: 1863
anno_stimato: false
scopritori: [Ferdinand Reich, Hieronymus Theodor Richter]
epoca: Spettroscopia e radioattività
categoria: metallo_post_transizione
gruppo: 13
periodo: 5
posizione_cronologica: 64
tempo_lettura: 4
...
flowchart LR
    E["Indio"]
    C1["Ossido di indio e stagno<br/>In2O3-SnO2"]
    E --> C1
    U1(["elettrodi trasparenti"])
    C1 --> U1
    U2(["schermi a cristalli liquidi"])
    C1 --> U2
    U3(["touchscreen"])
    C1 --> U3
    C2["Fosfuro di indio<br/>InP"]
    E --> C2
    U4(["laser per telecomunicazioni"])
    C2 --> U4
    U5(["celle solari ad alta efficienza"])
    C2 --> U5
    C3["Arseniuro di indio e gallio<br/>InGaAs"]
    E --> C3
    U6(["rivelatori a infrarossi"])
    C3 --> U6
    U7(["fotodiodi veloci"])
    C3 --> U7
