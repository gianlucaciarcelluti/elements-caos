...
anno_scoperta: 1913
anno_stimato: false
scopritori: [Kasimir Fajans, Oswald Helmuth Göhring]
epoca: Spettroscopia e radioattività
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 86
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, attinide, epoca/spettroscopia, secolo/XX]
aliases: [Pa, Protactinium]
---
...
```mermaid
timeline
    title Scoperta del Protoattinio
...
flowchart LR
    E["Protoattinio"]
    C1["Ossido di protoattinio<br/>Pa2O5"]
    E --> C1
    U1(["forma in cui l'elemento viene conservato e studiato"])
    C1 --> U1
    C2["Protoattinio-231<br/>231Pa"]
    E --> C2
    U2(["datazione dei sedimenti marini"])
    C2 --> U2
