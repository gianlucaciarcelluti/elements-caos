...
flowchart LR
    E["Platino"]
    C1["Acido esacloroplatinico<br/>H2PtCl6"]
    E --> C1
    U1(["precursore degli altri composti di platino"])
    C1 --> U1
    U2(["bagni di platinatura"])
    C1 --> U2
    U3(["inchiostri indelebili"])
    C1 --> U3
    C2["Cisplatino<br/>Pt(NH3)2Cl2"]
    E --> C2
    U4(["chemioterapia antitumorale"])
    C2 --> U4
    C3["Ossido di platino<br/>PtO2"]
    E --> C3
    U5(["catalizzatore di Adams per le idrogenazioni"])
    C3 --> U5
