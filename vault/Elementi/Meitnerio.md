...
flowchart LR
    E["Meitnerio"]
    C1["Esafluoruro di meitnerio<br/>MtF₆"]
    E --> C1
    U1(["composto previsto per analogia con l'esafluoruro di iridio, mai preparato"])
    C1 --> U1
    C2["Meitnerio-278<br/>278Mt"]
    E --> C2
    U2(["anello delle catene di decadimento usate per identificare gli elementi più pesanti"])
    C2 --> U2
