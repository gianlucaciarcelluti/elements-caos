...
flowchart LR
    E["Mendelevio"]
    C1["Mendelevio-256<br/>256Md"]
    E --> C1
    U1(["studi di chimica su pochi atomi"])
    C1 --> U1
    U2(["misura dei potenziali di riduzione"])
    C1 --> U2
    C2["Ione mendelevio(III)<br/>Md³⁺"]
    E --> C2
    U3(["separazione a scambio ionico"])
    C2 --> U3
    U4(["confronto con gli altri attinidi"])
    C2 --> U4
    C3["Ione mendelevio(II)<br/>Md²⁺"]
    E --> C3
    U5(["studio della stabilità del +2 alla fine della serie degli attinidi"])
    C3 --> U5
