...
flowchart LR
    E["Rodio"]
    C1["Cloruro di rodio<br/>RhCl3"]
    E --> C1
    U1(["precursore dei catalizzatori"])
    C1 --> U1
    U2(["placcature galvaniche"])
    C1 --> U2
    C2["Esacloridorodato di sodio<br/>Na3RhCl6"]
    E --> C2
    U3(["il sale rosa della scoperta"])
    C2 --> U3
    U4(["raffinazione del rodio"])
    C2 --> U4
    C3["Ossido di rodio<br/>Rh2O3"]
    E --> C3
    U5(["catalisi eterogenea"])
    C3 --> U5
    U6(["pigmenti ceramici"])
    C3 --> U6
