...
anno_scoperta: 1739
anno_stimato: false
scopritori: [Johann Heinrich Pott]
epoca: Alchimia e primo moderno
categoria: metallo_alcalino_terroso
gruppo: 2
periodo: 4
posizione_cronologica: 19
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, metallo-alcalino-terroso, epoca/alchimia, secolo/XVIII]
aliases: [Ca, Calcium]
---
...
flowchart LR
    E["Calcio"]
    C1["Carbonato di calcio<br/>CaCO3"]
    E --> C1
    U1(["calcare e marmo da costruzione"])
    C1 --> U1
    U2(["gusci e scheletri degli organismi marini"])
    C1 --> U2
    U3(["fondente per la siderurgia"])
    C1 --> U3
    C2["Ossido di calcio (calce viva)<br/>CaO"]
    E --> C2
    U4(["malte e cementi"])
    C2 --> U4
    U5(["correzione dei suoli acidi"])
    C2 --> U5
    C3["Solfato di calcio (gesso)<br/>CaSO4"]
    E --> C3
    U6(["intonaci e pannelli"])
    C3 --> U6
    U7(["forme e calchi ortopedici"])
    C3 --> U7
    C4["Idrossiapatite<br/>Ca5(PO4)3(OH)"]
    E --> C4
    U8(["struttura minerale di ossa e denti"])
    C4 --> U8
