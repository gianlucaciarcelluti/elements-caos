...
flowchart LR
    E["Rubidio"]
    C1["Cloruro di rubidio<br/>RbCl"]
    E --> C1
    U1(["biologia molecolare"])
    C1 --> U1
    U2(["reagente di laboratorio"])
    C1 --> U2
    C2["Carbonato di rubidio<br/>Rb2CO3"]
    E --> C2
    U3(["vetri speciali"])
    C2 --> U3
    U4(["catalizzatori"])
    C2 --> U4
    C3["Idrossido di rubidio<br/>RbOH"]
    E --> C3
    U5(["base fortissima"])
    C3 --> U5
    U6(["elettroliti per batterie a bassa temperatura"])
    C3 --> U6
