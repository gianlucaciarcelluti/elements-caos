...
flowchart LR
    E["Plutonio"]
    C1["Biossido di plutonio<br/>PuO2"]
    E --> C1
    U1(["combustibile nucleare"])
    C1 --> U1
    U2(["generatori termoelettrici a radioisotopi"])
    C1 --> U2
    C2["Esafluoruro di plutonio<br/>PuF6"]
    E --> C2
    U3(["processi di arricchimento e separazione isotopica"])
    C2 --> U3
