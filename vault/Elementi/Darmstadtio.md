...
```mermaid
timeline
    title Scoperta del Darmstadtio
...
flowchart LR
    E["Darmstadtio"]
    C1["Esafluoruro di darmstadtio<br/>DsF₆"]
    E --> C1
    U1(["composto previsto per analogia con l'esafluoruro di platino, mai preparato"])
    C1 --> U1
    C2["Darmstadtio-281<br/>281Ds"]
    E --> C2
    U2(["anello delle catene di decadimento degli elementi più pesanti"])
    C2 --> U2
