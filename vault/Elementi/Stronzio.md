...
flowchart LR
    E["Stronzio"]
    C1["Carbonato di stronzio<br/>SrCO3"]
    E --> C1
    U1(["colore rosso nella pirotecnica"])
    C1 --> U1
    U2(["produzione dei magneti al ferrite"])
    C1 --> U2
    C2["Nitrato di stronzio<br/>Sr(NO3)2"]
    E --> C2
    U3(["razzi di segnalazione rossi"])
    C2 --> U3
    C3["Solfato di stronzio<br/>SrSO4"]
    E --> C3
    U4(["celestina, principale minerale di stronzio"])
    C3 --> U4
    C4["Ferrite di stronzio<br/>SrFe12O19"]
    E --> C4
    U5(["magneti permanenti ceramici per piccoli motori"])
    C4 --> U5
