...
anno_scoperta: 1907
anno_stimato: false
scopritori: [Georges Urbain, Carl Auer von Welsbach]
epoca: Spettroscopia e radioattività
categoria: lantanide
gruppo: 3
periodo: 6
posizione_cronologica: 85
tempo_lettura: 4
...
flowchart LR
    E["Lutezio"]
    C1["Ossiortosilicato di lutezio drogato al cerio<br/>Lu2SiO5:Ce"]
    E --> C1
    U1(["rivelatori per tomografia a emissione di positroni"])
    C1 --> U1
    C2["Ossido di lutezio<br/>Lu2O3"]
    E --> C2
    U2(["catalizzatori"])
    C2 --> U2
    U3(["ceramiche ottiche"])
    C2 --> U3
    C3["Lutezio-177 legato a peptidi<br/>177Lu-DOTATATE"]
    E --> C3
    U4(["terapia radiometabolica dei tumori neuroendocrini"])
    C3 --> U4
