...
anno_scoperta: 1940
anno_stimato: false
scopritori: [Edwin McMillan, Philip Abelson]
epoca: Era nucleare
categoria: attinide
gruppo: 3
periodo: 7
posizione_cronologica: 92
tempo_lettura: 4
ha_approfondimento: false
tags: [elemento, attinide, epoca/nucleare, secolo/XX]
aliases: [Np, Neptunium]
---
...
flowchart LR
    E["Nettunio"]
    C1["Ossido di nettunio<br/>NpO2"]
    E --> C1
    U1(["bersagli per la produzione di plutonio-238"])
    C1 --> U1
    C2["Nettunio-237<br/>237Np"]
    E --> C2
    U2(["rivelatori di neutroni"])
    C2 --> U2
    U3(["precursore del plutonio-238"])
    C2 --> U3
